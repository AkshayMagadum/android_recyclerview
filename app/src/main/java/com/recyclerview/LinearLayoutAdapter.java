...
public class LinearLayoutAdapter extends RecyclerView.Adapter<LinearLayoutAdapter.View_Holder> {

    ArrayList<DataModel> mDataModelArrayList;
    Context mContext;

    public LinearLayoutAdapter(ArrayList<DataModel> dataModelArrayList, Context applicationContext) {
    ...
    @Override
    public LinearLayoutAdapter.View_Holder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(LinearLayoutAdapter.View_Holder holder, int position) {
